...
" }}}
" NVIM_DEFAULT_BEHAVIOR (For info only) "{{{
" ---------------------------------------------------------------------
...
" FONTS_AND_GUI "{{{
" ---------------------------------------------------------------------
" INFO: Font is decided by terminal not neovim itself.
"  Until it's fixed in next neovim version, currently "gui_running" always
"  FALSE so don't use it
"if has ("gui_running")
    " Set global font
